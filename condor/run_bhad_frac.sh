...
# Always starting cmssw on el7 singularity on condor
# even if submit file requires MY.WantOS = "el7". Otherwise it sometimes fails
cmssw-el7 
...
python B2_star_distr.py -b ${HT_bin} -o ${OUTDIR} -i ${fileName} -s ${sample} -d ${ID}
